    ...
    rootEl.innerHTML = `
      <div style="min-height:100vh;background:#080F05;color:#F0EAD6;">
        ...
        <footer style="border-top:1px solid var(--border);padding:24px 16px;text-align:center;font-size:.75rem;color:var(--text3);background:rgba(14,25,13,.5);">
          ...
          <div style="margin-top:4px;">Tecnologia <a href="https://fingo.api.br" target="_blank" rel="noopener" style="color:var(--accent);text-decoration:none;font-weight:700;">FinGo</a> &middot; Gestão de Obras e Engenharia</div>
        </footer>
      </div>`;
  },
