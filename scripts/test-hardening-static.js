...
ok('Configuração de usuários grava via /api/users', /(?:fetch|_fetchWithTimeout)\('\\/api\\/users'/.test(cfg));
ok('Configuração de empresa grava via /api/tenant', /(?:fetch|_fetchWithTimeout)\('\\/api\\/tenant'/.test(cfg));
