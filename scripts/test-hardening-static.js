...
ok('Configuração de usuários grava via /api/users', /\b(?:fetch|_fetchWithTimeout)\(\s*['"]\/api\/users['"]/.test(cfg));
ok('Configuração de empresa grava via /api/tenant', /\b(?:fetch|_fetchWithTimeout)\(\s*['"]\/api\/tenant['"]/.test(cfg));
