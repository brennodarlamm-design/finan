...
const Recibos = {
  ...
  enviarWhatsApp(id) {
    ...
    const texto = `🧾 *COMPROVANTE DE RECIBO OFICIAL*\n*${brandName.toUpperCase()}*\n\n` +
      ...
      validacaoTxt +
      `\n_Documento emitido eletronicamente via Sistema FinGo._`;
