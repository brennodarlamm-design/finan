...
assert(workflow.includes('cancel-in-progress: true'), 'Execuções antigas devem ser canceladas para impedir deploy de commit obsoleto.');
...
console.log('✅ Patch 32: CI/CD de produção, secrets guard, cancelamento de runs obsoletas e smoke tests validados.');
