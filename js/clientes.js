    ...
    return cs.map(c => {
      ...
      return `<div class="card" style="position:relative;transition:transform .15s, border-color .15s;">
        ...
        <div style="display:flex;gap:7px;margin-top:12px;flex-wrap:wrap;">
          ...
          <button class="btn btn-secondary btn-sm" style="background:rgba(198,255,0,.12);color:var(--accent);border-color:rgba(198,255,0,.3);font-weight:700;" data-fb-click="PortalCliente.abrirModalCompartilhar" data-fb-click-n="1" data-fb-click-t0="string" data-fb-click-v0="${encodeURIComponent(String(c.id))}" title="Compartilhar Portal do Cliente via Link / WhatsApp">🌐 Portal</button>
