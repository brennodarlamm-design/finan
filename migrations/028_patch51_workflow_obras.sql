...
CREATE OR REPLACE FUNCTION finobra_enforce_sla_increase_only() RETURNS TRIGGER LANGUAGE plpgsql AS '
BEGIN
...
CREATE OR REPLACE FUNCTION finobra_complete_workflow_stage(p_tenant_id VARCHAR,p_obra_id VARCHAR,p_etapa_id VARCHAR,p_actor_user_id VARCHAR) RETURNS JSONB LANGUAGE plpgsql AS '
